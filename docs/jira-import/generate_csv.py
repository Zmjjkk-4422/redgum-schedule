...
rows = [
    ...
    story("RED-03 Tutor availability domain rule with negative tests", EPIC_CORE,
          ...
          5, "High", "committed-sprint-1 owner-max owner-jiao-tests"),
...
parked = [
    ...
    ("PARK-02 Overlapping/double-booking detection across tutors",
     "warnings when sessions overlap for the same student or tutor",
     "double bookings like the June incident cannot recur",
     ["Overlap detection on create and move", "Warning or refusal with reason"],
     "Explicitly out of scope; redesign with the room model in a later epic."),
